...
tasks.register<Jar>("buildPluginJar") {
    archiveFileName.set("boss-plugin-role-creation-${version}.jar")
    duplicatesStrategy = DuplicatesStrategy.EXCLUDE
    
    manifest {
        attributes(
            "Implementation-Title" to "BOSS Role Creation Plugin",
            "Implementation-Version" to version,
            "Main-Class" to "ai.rever.boss.plugin.dynamic.rolecreation.RoleCreationDynamicPlugin"
        )
    }
