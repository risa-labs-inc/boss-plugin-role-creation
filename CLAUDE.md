...
**Role Creation (Dynamic)** (`ai.rever.boss.plugin.dynamic.rolecreation`) is a dynamic plugin for the BOSS desktop application.

Create and configure custom roles and permissions

- **Plugin ID**: `ai.rever.boss.plugin.dynamic.rolecreation`
- **Main Class**: `ai.rever.boss.plugin.dynamic.rolecreation.RoleCreationDynamicPlugin`
- **API Version**: 1.0.20
